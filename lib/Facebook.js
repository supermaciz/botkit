                ...
                for (var m = 0; m < obj.entry[e].messaging.length; m++) {
                    ...
                    if (facebook_message.message) {
                        ...
                        var message = {
                            ...
                            channel: facebook_message.sender.id,
                            timestamp: facebook_message.timestamp,
                            authorization_code: facebook_message.account_linking.authorization_code,
                            status: facebook_message.account_linking.status,
                        };

                        facebook_botkit.trigger('account_linking', [bot, message]);
                    }  else {
